    ...
    <div className="min-h-screen bg-[#F0FDFA] text-[#1E293B] selection:bg-[#16A34A] selection:text-black">
      ...
      <nav className="border-b border-[#CCFBF1] bg-[#FFFFFF]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-[#475569]">
            <button onClick={() => setIsFeaturesOpen(true)} className="hover:text-[#16A34A] transition-colors">Features</button>
            <button onClick={() => { setTourJourney('select'); setTourStep(1); setIsTourOpen(true); }} className="hover:text-[#16A34A] transition-colors">Video Tour</button>
            <a href="#gyms" className="hover:text-[#16A34A] transition-colors">Gyms</a>
      ...
      <main>
        <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center flex flex-col items-center">
          <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#16A34A]/10 via-[#F8FAFC]/0 to-[#F8FAFC]/0"></div>
          
          <span className="px-4 py-1.5 rounded-full bg-[#FFFFFF] border border-[#CCFBF1] text-[#16A34A] text-sm font-medium inline-block mb-6">
            The Future of Fitness is Here
          </span>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-8 leading-tight">
            Your Personal <span className="text-[#16A34A]">AI Fitness Coach</span> <br className="hidden md:block"/> + Human Trainer
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
            <Link to="/gyms" className="w-full sm:w-auto px-8 py-4 bg-[#16A34A] text-[#1E293B] font-semibold rounded-xl hover:bg-[#15803D] transition-all flex items-center justify-center space-x-2 shadow-lg shadow-[#16A34A]/20">
              <span>Find a Gym</span>
              <ArrowRight size={20} />
            </Link>
            <Link to="/gym-owner-introduction" className="w-full sm:w-auto px-8 py-4 bg-[#16A34A] text-[#1E293B] font-semibold rounded-xl hover:bg-[#15803D] transition-all flex items-center justify-center space-x-2 shadow-lg shadow-[#16A34A]/20">
              <span>Manage Your Gym</span>
              <ArrowRight size={20} />
            </Link>
          </div>

          <div className="w-full max-w-5xl rounded-3xl overflow-hidden border border-[#CCFBF1] shadow-[0_0_50px_rgba(212,255,0,0.1)] relative">
        ...
        {/* Feature Highlights */}
        <section className="border-t border-[#CCFBF1] bg-[#FFFFFF] py-24" id="features">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Everything You Need to Succeed</h2>
              <p className="text-[#475569]">A complete ecosystem designed for members, trainers, and gym owners.</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="bg-[#FFFFFF] p-8 rounded-2xl border border-[#CCFBF1] hover:border-[#16A34A]/50 transition-colors">
                <div className="w-12 h-12 bg-[#16A34A]/10 rounded-xl flex items-center justify-center mb-6 text-[#16A34A]">
                  <Bot size={24} />
                </div>
              ...
              {/* Feature 2 */}
              <div className="bg-[#FFFFFF] p-8 rounded-2xl border border-[#CCFBF1] hover:border-[#22C55E]/50 transition-colors">
              ...
              {/* Feature 3 */}
              <div className="bg-[#FFFFFF] p-8 rounded-2xl border border-[#CCFBF1] hover:border-[#aa3bff]/50 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              <div className="lg:w-1/2">
                <h2 className="text-3xl md:text-5xl font-bold mb-6">See the <span className="text-[#16A34A]">Platform</span> in Action</h2>
                ...
                <div className="flex space-x-4">
                  ...
                  <span className="text-[#475569]">from 10k+ users</span>
                </div>
              </div>
              <div className="lg:w-1/2 w-full flex flex-col space-y-6">
                ...
                >
                  <div className="absolute inset-0 bg-[#16A34A] rounded-2xl transform translate-x-2 translate-y-2 opacity-20 group-hover:translate-x-4 group-hover:translate-y-4 transition-transform"></div>
                  <div className="relative rounded-2xl overflow-hidden border border-[#CCFBF1] aspect-video bg-[#FFFFFF] flex items-center justify-center">
                    ...
                    <div className="w-20 h-20 bg-[#16A34A] rounded-full flex items-center justify-center text-black z-10 hover:scale-110 transition-transform shadow-[0_0_30px_rgba(212,175,55,0.5)]">
                ...
                {/* Related Videos */}
                <div>
                  <h3 className="text-[#1E293B] font-bold mb-3 flex items-center space-x-2">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      ...
                      >
                        <div className="relative aspect-video rounded-xl overflow-hidden border border-[#CCFBF1] mb-2 bg-[#FFFFFF]">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                            <PlayCircle size={24} className="text-[#16A34A]" />
                          </div>
                          <div className="absolute bottom-2 right-2 bg-black/80 backdrop-blur-sm text-[#1E293B] text-[10px] font-bold px-1.5 py-0.5 rounded">
                            {video.time}
                          </div>
                        </div>
                        <p className="text-xs text-[#475569] group-hover:text-[#16A34A] transition-colors line-clamp-1 font-medium">{video.title}</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <section className="border-t border-[#CCFBF1] bg-[#FFFFFF] py-24" id="how-it-works">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">How It Works</h2>
              <p className="text-[#475569]">Your journey to peak fitness in 4 simple steps.</p>
            </div>
            <div className="grid md:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={idx} className="relative flex flex-col items-center">
                  <div className="w-16 h-16 bg-[#FFFFFF] border border-[#CCFBF1] rounded-full flex items-center justify-center text-[#16A34A] font-bold text-xl z-10 mb-6">
                    {item.step}
                  </div>
                  <item.icon size={32} className="text-[#475569] mb-4" />
        ...
        <section className="py-24 relative overflow-hidden" id="gyms">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row justify-between items-end mb-12">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Discover Premium <span className="text-[#16A34A]">Gyms</span></h2>
                <p className="text-[#475569] max-w-xl">Find and join the best fitness centers in your area. Use your AI GYM membership to access state-of-the-art facilities.</p>
              </div>
              <Link
                to="/gyms"
                className="hidden md:flex items-center space-x-2 text-[#16A34A] hover:text-[#15803D] transition-colors font-semibold mt-4 md:mt-0"
              >
            ...
            {gymsLoading ? (
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={idx} className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl overflow-hidden group cursor-pointer hover:border-[#16A34A]/50 transition-colors">
                    <div className="h-48 overflow-hidden relative">
                      ...
                      <div className="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-2 py-1 rounded-lg flex items-center space-x-1 border border-[#CCFBF1]">
                        <Star size={14} className="text-[#16A34A]" fill="currentColor" />
                        <span className="text-xs font-bold">{gym.rating}</span>
                      </div>
                    </div>
                    <div className="p-6">
                      <h3 className="text-xl font-bold mb-1">{gym.name}</h3>
                      <div className="flex items-center space-x-1 text-[#475569] text-sm mb-4">
                        <MapPin size={14} />
                        <span>{gym.location}</span>
                      </div>
                      <div className="flex flex-wrap gap-2">
                        {gym.tags.map((tag, tIdx) => (
                          <span key={tIdx} className="text-xs font-medium px-2 py-1 bg-[#E2E8F0] rounded-md text-[#475569]">{tag}</span>
                        ))}
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {featuredGyms.map((gym) => (
                  <Link
                    key={gym._id}
                    to={`/gyms/${gym._id}`}
                    className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl overflow-hidden group hover:border-[#16A34A]/60 hover:shadow-[0_0_30px_rgba(212,175,55,0.1)] transition-all duration-300 block"
                  >
                    <div className="h-48 overflow-hidden relative">
                      {gym.logo ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] flex items-center justify-center">
                          <Activity size={48} className="text-[#E2E8F0]" />
                        </div>
                      )}
                      <div className="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-2.5 py-1 rounded-lg flex items-center space-x-1 border border-[#CCFBF1]">
                        <Star size={14} className="text-[#16A34A]" fill="currentColor" />
                        <span className="text-white text-xs font-bold">{gym.rating || 4.5}</span>
                      </div>
                      {gym.gymType && (
                        <div className="absolute top-4 left-4 bg-[#16A34A] text-white text-xs font-bold px-2.5 py-1 rounded-full">
                          {gym.gymType}
                        </div>
                      )}
                    </div>
                    <div className="p-6">
                      <h3 className="text-xl font-bold mb-1 group-hover:text-[#16A34A] transition-colors">{gym.name}</h3>
                      <div className="flex items-center space-x-1 text-[#475569] text-sm mb-4">
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        {(gym.facilities || []).slice(0, 2).map((tag: string, tIdx: number) => (
                          <span key={tIdx} className="text-xs font-medium px-2.5 py-1 bg-[#E2E8F0] rounded-md text-[#475569]">{tag}</span>
                        ))}
                        {gym.facilities?.length > 2 && (
                          <span className="text-xs font-medium px-2.5 py-1 bg-[#16A34A]/10 text-[#16A34A] rounded-md border border-[#16A34A]/30">
                            +{gym.facilities.length - 2}
                          </span>
                        )}
                      </div>
                      <div className="pt-4 border-t border-[#CCFBF1] flex items-center justify-end">
                        <div className="px-5 py-2 bg-[#16A34A]/10 text-[#16A34A] group-hover:bg-[#16A34A] group-hover:text-white rounded-xl text-sm font-bold transition-colors shadow-sm">
                          View Details
                        </div>
                      </div>
                    </div>
            ...
            <div className="mt-8 text-center md:hidden">
              <Link to="/gyms" className="inline-flex items-center gap-2 text-[#16A34A] hover:text-[#15803D] font-semibold">
        ...
        {/* Platform Stats */}
        <section className="border-t border-[#CCFBF1] bg-gradient-to-br from-[#FFFFFF] to-[#F8FAFC] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-[#E2E8F0]/50">
              {[
                ...
                <div key={idx} className={`text-center ${idx % 2 === 0 ? 'pr-8' : 'pl-8 md:pl-0'} ${idx > 0 && idx % 2 === 0 ? 'pl-8 border-l-0 md:border-l' : ''}`}>
                  <div className="text-4xl md:text-5xl font-extrabold text-[#16A34A] mb-2 tracking-tight">{stat.value}</div>
                  <div className="text-[#475569] font-medium text-sm md:text-base uppercase tracking-wider">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24" id="pricing">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <div className="inline-flex items-center space-x-2 bg-[#16A34A]/10 border border-[#16A34A]/30 rounded-full px-4 py-1.5 text-[#16A34A] text-xs font-bold uppercase tracking-widest mb-5">
              ...
              <p className="text-[#475569] mb-8 max-w-xl mx-auto">All plans give your gym access to the AI GYM platform. Scale as your gym grows.</p>
              ...
              <div className="flex items-center justify-center gap-4 flex-wrap">
                ...
                <button
                  ...
                  className={`relative inline-flex h-8 w-16 items-center rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#16A34A] focus:ring-offset-2 ${isAnnual ? 'bg-[#16A34A]' : 'bg-[#CBD5E1]'}`}
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isAnnual ? (
                    ...
                    <span className="text-xs bg-[#F0FDFA] text-[#0D9488] border border-[#CCFBF1] px-3 py-1 rounded-full">Switch to annual & save up to 25%</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6">
              {[
                { 
                  ...
                  defaultBorder: 'border-[#CCFBF1] border-dashed',
                  selBorder: 'border-[#0D9488]',
                  selBar: 'bg-[#0D9488]',
                  priceColor: 'text-[#1E293B]',
                  checkColor: 'text-[#0D9488]',
                  btnDefault: 'bg-white border-2 border-[#CCFBF1] text-[#1E293B] hover:border-[#16A34A]',
                  btnSelected: 'bg-[#0D9488] text-white',
                },
                { 
                  key: 'SILVER',
                  ...
                  defaultBorder: 'border-[#CCFBF1]',
                  selBorder: 'border-[#0D9488]',
                  selBar: 'bg-[#0D9488]',
                  priceColor: 'text-[#0D9488]',
                  checkColor: 'text-[#0D9488]',
                  btnDefault: 'bg-white border-2 border-[#CCFBF1] text-[#1E293B] hover:border-[#0D9488]',
                  btnSelected: 'bg-[#0D9488] text-white',
                },
                { 
                  key: 'GOLD',
                  ...
                  defaultBorder: 'border-[#16A34A] border-2',
                  selBorder: 'border-[#16A34A]',
                  selBar: 'bg-[#16A34A]',
                  priceColor: 'text-[#16A34A]',
                  checkColor: 'text-[#16A34A]',
                  btnDefault: 'bg-[#16A34A] text-white hover:bg-[#15803D] shadow-lg shadow-green-200',
                  btnSelected: 'bg-[#16A34A] text-white hover:bg-[#15803D]',
                },
                { 
                  key: 'PREMIUM',
                    ...
                    <div className="p-6 flex flex-col flex-1">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className={`text-[10px] px-2 py-0.5 rounded-md font-bold uppercase tracking-wider ${
                          plan.popular ? 'bg-[#16A34A]/10 text-[#16A34A]' : 'bg-[#F0FDFA] text-[#0D9488]'
                        }`}>{plan.badge}</span>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        {(plan as any).annualTotal && <p className="text-[#475569] text-xs mt-0.5">{(plan as any).annualTotal}</p>}
                        {plan.savings && <p className="text-green-600 text-xs mt-1 font-semibold">{plan.savings}</p>}
                        {!isAnnual && !plan.trial && (
                          <p className="text-[#94A3B8] text-xs mt-0.5">or save 25% with annual</p>
                        )}
                      </div>

                      <div className="bg-[#F8FAFC] rounded-xl px-3 py-2 mb-4 border border-[#CCFBF1]">
                        <p className="text-[10px] uppercase tracking-wider font-bold mb-0.5 text-[#475569]">Platform Limits</p>
                        <p className="text-xs text-[#1E293B] font-medium">{plan.limits}</p>
                      </div>

                      <ul className="space-y-1.5 mb-4 flex-1">
                        {plan.features.map((feature, fIdx) => (
                          <li key={fIdx} className="flex items-start gap-2 text-xs text-[#1E293B]">
        ...
        {/* Testimonials */}
        <section className="border-t border-[#CCFBF1] bg-[#FFFFFF] py-24" id="testimonials">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Don't Just Take Our Word For It</h2>
              <p className="text-[#475569]">See what our community is saying about AI GYM.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="bg-[#FFFFFF] border border-[#CCFBF1] p-8 rounded-2xl relative">
                  <Quote className="absolute top-8 right-8 text-[#E2E8F0]" size={48} />
                  <div className="flex items-center space-x-1 mb-4 text-[#16A34A]">
                    {[1, 2, 3, 4, 5].map((s) => <Star key={s} size={16} fill="currentColor" />)}
                  </div>
                  <p className="text-[#475569] italic mb-6 relative z-10 leading-relaxed">"{review.text}"</p>
                  <div>
                    <h4 className="font-bold text-[#1E293B]">{review.name}</h4>
                    <span className="text-xs text-[#16A34A] uppercase tracking-wider font-semibold">{review.role}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* Detailed Footer */}
      <footer className="border-t border-[#CCFBF1] bg-[#FFFFFF] pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#475569] hover:text-[#16A34A] transition-colors"><FaInstagram size={20} /></a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-[#475569] hover:text-[#16A34A] transition-colors"><FaTwitter size={20} /></a>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[#475569] hover:text-[#16A34A] transition-colors"><FaFacebook size={20} /></a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-[#475569] hover:text-[#16A34A] transition-colors"><FaYoutube size={20} /></a>
              </div>
            </div>

            <div>
              <h4 className="text-[#1E293B] font-semibold mb-4">Navigate</h4>
              <ul className="space-y-2 text-sm text-[#475569]">
                <li><button onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); setIsFeaturesOpen(true); }} className="hover:text-[#16A34A] transition-colors">Features</button></li>
                <li><button onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); setTourJourney('select'); setTourStep(1); setIsTourOpen(true); }} className="hover:text-[#16A34A] transition-colors">Video Tour</button></li>
                <li><a href="#gyms" className="hover:text-[#16A34A] transition-colors">Gyms</a></li>
                <li><a href="#pricing" className="hover:text-[#16A34A] transition-colors">Pricing</a></li>
              </ul>
            </div>

            <div>
              <h4 className="text-[#1E293B] font-semibold mb-4">Company</h4>
              <ul className="space-y-2 text-sm text-[#475569]">
                <li><Link to="/about" className="hover:text-[#16A34A] transition-colors">About Us</Link></li>
                <li><Link to="/careers" className="hover:text-[#16A34A] transition-colors">Careers</Link></li>
                <li><Link to="/blog" className="hover:text-[#16A34A] transition-colors">Blog</Link></li>
                <li><Link to="/contact" className="hover:text-[#16A34A] transition-colors">Contact</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="text-[#1E293B] font-semibold mb-4">Account</h4>
              <ul className="space-y-2 text-sm text-[#475569]">
                <li><Link to="/login" className="hover:text-[#16A34A] transition-colors">Log In</Link></li>
                <li><Link to="/register/customer" className="hover:text-[#16A34A] transition-colors">Sign In (Register)</Link></li>
                <li><Link to="/privacy-policy" className="hover:text-[#16A34A] transition-colors">Privacy Policy</Link></li>
                <li><Link to="/terms-of-service" className="hover:text-[#16A34A] transition-colors">Terms of Service</Link></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-[#CCFBF1] pt-8 text-center text-sm text-[#475569]">
      ...
      {activeVideo && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/90 backdrop-blur-sm" onClick={() => setActiveVideo(null)}>
          <div 
            className="relative w-full max-w-5xl aspect-video bg-black rounded-2xl overflow-hidden border border-[#CCFBF1] shadow-[0_0_50px_rgba(0,0,0,0.5)]"
            onClick={(e) => e.stopPropagation()}
          >
            <button 
              onClick={() => setActiveVideo(null)}
              className="absolute top-4 right-4 z-10 w-10 h-10 bg-black/50 hover:bg-[#16A34A] text-white hover:text-black rounded-full flex items-center justify-center transition-colors"
            >
              <X size={24} />
            </button>
            <iframe 
      ...
      {isFeaturesOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-[#0F172A]/80 backdrop-blur-sm animate-in fade-in duration-300" onClick={() => setIsFeaturesOpen(false)}>
          <div className="bg-[#FFFFFF] rounded-3xl w-full max-w-6xl max-h-[90vh] overflow-y-auto overflow-x-hidden shadow-2xl flex flex-col" onClick={e => e.stopPropagation()}>
            {/* Header */}
            <div className="flex justify-between items-center p-6 border-b border-[#CCFBF1]">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#1E293B]">Everything You Need for a Smarter Fitness Journey</h2>
              <button onClick={() => setIsFeaturesOpen(false)} className="p-2 text-[#475569] hover:bg-[#F0FDFA] rounded-full transition-colors">
                <X size={24} />
              </button>
            </div>
            ...
            <div className="flex flex-col lg:flex-row p-6 gap-8 h-full">
              ...
              <div className="w-full lg:w-1/3 flex flex-col space-y-4">
                {[
                  ...
                  <div key={tab.id} onClick={() => setActiveFeatureTab(tab.id as any)} className={`p-5 rounded-2xl cursor-pointer transition-all border-2 ${activeFeatureTab === tab.id ? 'border-[#16A34A] bg-[#F0FDFA] shadow-lg shadow-[#16A34A]/10' : 'border-transparent bg-[#F8FAFC] hover:border-[#CCFBF1]'}`}>
                    <div className="flex items-center space-x-3 mb-3">
                      <div className={`p-2 rounded-xl ${activeFeatureTab === tab.id ? 'bg-[#16A34A] text-white' : 'bg-[#E2E8F0] text-[#475569]'}`}>
                        <tab.icon size={24} />
                      </div>
                      <h3 className={`text-lg font-bold ${activeFeatureTab === tab.id ? 'text-[#16A34A]' : 'text-[#1E293B]'}`}>{tab.title}</h3>
                    </div>
                    {activeFeatureTab === tab.id && (
                      <ul className="space-y-2 mt-4 animate-in slide-in-from-top-2 duration-300">
                        {tab.items.map((item, idx) => (
                          <li key={idx} className={`flex items-start space-x-2 text-sm transition-colors duration-300 ${featureSlideIndex === idx ? 'text-[#16A34A] font-bold' : 'text-[#475569]'}`}>
                            <CheckCircle size={16} className={`${featureSlideIndex === idx ? 'text-[#16A34A]' : 'text-[#94A3B8]'} shrink-0 mt-0.5 transition-colors`} />
                            <span>{item}</span>
                          </li>
                        ))}
                      </ul>
              ...
              {/* Preview Area */}
              <div className="w-full lg:w-2/3 bg-[#F8FAFC] rounded-2xl border border-[#CCFBF1] flex items-center justify-center p-8 relative overflow-hidden">
                <FeaturePreview 
      ...
      {isTourOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-[#0F172A]/90 backdrop-blur-md animate-in fade-in duration-300" onClick={() => setIsTourOpen(false)}>
          <div className="relative w-full max-w-6xl bg-[#1E293B] rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(22,163,74,0.15)] flex flex-col h-[85vh] border border-[#334155]" onClick={e => e.stopPropagation()}>
            {/* Header */}
            <div className="flex justify-between items-center p-4 border-b border-[#334155] bg-[#0F172A] shrink-0">
              <div className="flex items-center space-x-3">
                <PlayCircle className="text-[#16A34A]" size={20} />
              ...
              <button onClick={() => setIsTourOpen(false)} className="text-[#94A3B8] hover:text-white transition-colors">
                <X size={24} />
              </button>
            </div>
            
            {/* Slide Area */}
            <div className="flex-1 relative overflow-y-auto flex items-center justify-center p-8 bg-gradient-to-br from-[#1E293B] to-[#0F172A]">
               <TourSlide 
                 journey={tourJourney} 
                 step={tourStep} 
