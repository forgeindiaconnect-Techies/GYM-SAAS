...
const SuperAdminCustomers = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'APPROVED': return 'bg-[#164A4A]/10 text-[#164A4A] border-[#164A4A]/20';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#202828]">Customer Details</h1>
          <p className="text-[#455250] text-sm mt-1">Manage all registered members and their approval statuses.</p>
        </div>
      </div>
      ...
      <div className="bg-[#FFFFFF] border border-[#D3DFDA] rounded-xl overflow-hidden relative min-h-[400px]">
        {loading ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-[#455250]">
            ...
            <p className="text-lg font-medium text-[#202828] mb-1">No customers found</p>
                  ...
                  <tr key={customer._id} className="hover:bg-[#F2EFE8] transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-medium text-[#202828]">{customer.firstName} {customer.lastName}</div>
                          <div className="text-xs text-[#455250]">Member</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="font-medium text-[#202828]">{customer.gymId?.name || 'No Gym'}</div>
                      <div className="text-xs text-[#455250]">{customer.branchId?.name || 'Local'}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="font-medium text-[#202828]">{customer.subscriptionPlan || 'No Plan'}</div>
