  ...
  return (
    <div className="min-h-screen bg-[#F0FDFA] text-[#1E293B] selection:bg-[#16A34A] selection:text-black">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <span className="text-[#16A34A] text-sm font-bold uppercase tracking-wider mb-4 block">Our Story</span>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#CCFBF1]">
            <h3 className="text-[#1E293B] font-bold text-xl mb-2">100k+</h3>
            <p className="text-[#475569] text-sm">Active Members worldwide</p>
          </div>
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#CCFBF1]">
            <h3 className="text-[#1E293B] font-bold text-xl mb-2">5,000+</h3>
            <p className="text-[#475569] text-sm">Certified Trainers</p>
          </div>
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#CCFBF1]">
            <h3 className="text-[#1E293B] font-bold text-xl mb-2">1M+</h3>
            <p className="text-[#475569] text-sm">AI Plans Generated</p>
          </div>
        </div>
      </main>
    </div>
