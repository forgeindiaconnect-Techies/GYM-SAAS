  ...
  return (
    <div className="min-h-screen bg-[#F5F3EE] text-[#202522] selection:bg-[#34483F] selection:text-black">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <span className="text-[#34483F] text-sm font-bold uppercase tracking-wider mb-4 block">Our Story</span>
        <h1 className="text-4xl md:text-5xl font-bold mb-8">About AI GYM</h1>
        <div className="space-y-6 text-[#4A514D] text-lg leading-relaxed">
          <p>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#DCD9CD]">
            <h3 className="text-[#202522] font-bold text-xl mb-2">100k+</h3>
            <p className="text-[#4A514D] text-sm">Active Members worldwide</p>
          </div>
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#DCD9CD]">
            <h3 className="text-[#202522] font-bold text-xl mb-2">5,000+</h3>
            <p className="text-[#4A514D] text-sm">Certified Trainers</p>
          </div>
          <div className="bg-[#FFFFFF] p-6 rounded-2xl border border-[#DCD9CD]">
            <h3 className="text-[#202522] font-bold text-xl mb-2">1M+</h3>
            <p className="text-[#4A514D] text-sm">AI Plans Generated</p>
          </div>
        </div>
      </main>
    </div>
