    ...
    <div className="min-h-screen bg-[#F1F5F3] text-[#202828] selection:bg-[#164A4A] selection:text-black">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="space-y-8 text-[#455250] leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">1. Agreement to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">2. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">3. Medical Disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">4. Subscriptions</h2>
            <p>
