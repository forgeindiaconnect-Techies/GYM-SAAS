    ...
    <div className="min-h-screen bg-[#F1F5F3] text-[#202828] selection:bg-[#164A4A] selection:text-black">
      <nav className="border-b border-[#D3DFDA] bg-[#FFFFFF]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <button onClick={handleBack} className="text-sm font-medium text-[#455250] hover:text-[#164A4A] flex items-center space-x-2">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <p className="text-[#455250] mb-12">Last updated: September 5, 2026</p>

        <div className="space-y-8 text-[#455250] leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">1. Information We Collect</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">3. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#202828] mb-4">4. Contact Us</h2>
            <p>
              If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@aigym.com" className="text-[#164A4A] hover:underline">privacy@aigym.com</a>.
            </p>
          </section>
        </div>
      </main>
