    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-[#455250] mt-1">Manage personal training appointments and class reservations.</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex space-x-2">
          <button className="px-4 py-3 bg-[#FFFFFF] border border-[#D3DFDA] text-[#202828] rounded-xl hover:bg-[#FFFFFF] transition-colors font-medium">
            All Status
          </button>
          <button className="px-4 py-3 bg-[#FFFFFF] border border-[#D3DFDA] text-[#202828] rounded-xl hover:bg-[#FFFFFF] transition-colors font-medium">
            Date Range
          ...
          <table className="w-full text-left text-sm text-[#455250] whitespace-nowrap">
            ...
            <tbody className="divide-y divide-[#D3DFDA]">
              {mockBookings.map((booking) => (
                <tr key={booking.id} className="hover:bg-[#F1F5F3] transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className="flex items-center"><User size={14} className="mr-2 text-[#455250]"/> {booking.trainer}</span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="space-y-1 text-xs">
                      <p className="flex items-center text-[#202828]"><CalendarIcon size={12} className="mr-1.5 text-[#164A4A]"/> {booking.date}</p>
                  ...
                  <td className="px-6 py-4 text-right">
                    <button className="p-2 text-[#455250] hover:text-[#202828] hover:bg-[#FFFFFF] rounded-lg transition-colors">
