    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            <Bot className="text-[#16A34A]" size={32} />
            AI Models & Usage
          </h1>
          <p className="text-[#475569] mt-2">Manage AI model parameters and token usage across the platform.</p>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        <div className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl p-6">
          <h3 className="text-[#475569] text-sm mb-2">Total AI Generations (Today)</h3>
          <p className="text-4xl font-bold text-[#16A34A]">12,492</p>
          <div className="w-full bg-[#E2E8F0] h-2 rounded-full mt-4">
            <div className="bg-[#16A34A] h-2 rounded-full" style={{ width: '65%' }}></div>
          </div>
          <p className="text-xs text-[#475569] mt-2">65% of daily token limit</p>
        </div>
        <div className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl p-6">
