      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            <Receipt className="text-[#34483F]" size={32} />
            Transaction Logs
          </h1>
          <p className="text-[#4A514D] mt-2">Detailed ledger of all financial movements.</p>
        </div>
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="bg-[#FFFFFF] border border-[#DCD9CD] p-4 rounded-xl flex justify-between items-center">
             <div>
               ...
               <p className="text-xs text-[#4A514D]">Oct {i}, 2026 • Stripe • TXN_00{i}</p>
             </div>
