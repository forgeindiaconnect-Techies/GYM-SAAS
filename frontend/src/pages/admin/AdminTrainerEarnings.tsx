      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            <TrendingUp className="text-[#164A4A]" size={32} />
            Trainer Earnings
          </h1>
          <p className="text-[#455250] mt-2">Monitor trainer revenues and outstanding balances.</p>
        </div>
        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-[#FFFFFF] border border-[#D3DFDA] rounded-2xl p-5">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-xs bg-[#E8E5DA] px-2 py-1 rounded text-[#455250]">85% Split</div>
            </div>
            <p className="text-sm text-[#455250]">Pending Payout</p>
            <p className="text-2xl font-bold text-[#164A4A] mb-4">${(i * 450).toFixed(2)}</p>
