  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      <div className="flex items-center space-x-4">
        <Link to="/admin/trainers" className="p-2 bg-[#FFFFFF] hover:bg-[#E8E5DA] rounded-xl transition-colors">
          <ArrowLeft size={20} />
        </Link>
        <div>
      ...
      <form className="space-y-8">
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end items-center gap-4 pt-4">
          ...
          <button 
            ...
            className="w-full sm:w-auto px-6 py-3 bg-[#E8E5DA] text-white rounded-xl font-semibold hover:bg-[#333] transition-colors flex items-center justify-center gap-2"
          >
            <Save size={18} />
