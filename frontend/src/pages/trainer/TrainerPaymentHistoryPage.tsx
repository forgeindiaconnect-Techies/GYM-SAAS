  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#202522]">Payment History</h1>
          <p className="text-[#727975] text-sm mt-1">Your complete payment record from your Gym Owner</p>
        </div>
        {totalReceived > 0 && (
      ...
      <div className="bg-white border border-[#E8E5DA] rounded-2xl overflow-hidden shadow-sm">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-[#727975] font-semibold">No payment records yet</p>
