  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-[#475569]">In-person physical training and classes</p>
      </div>
          ...
          <div key={i} className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-2 text-sm text-[#475569]">
                <p className="flex items-center gap-2"><Clock size={16} className="text-[#16A34A]"/> {session.time}</p>
            ...
            <div className="mt-6 pt-4 border-t border-[#CCFBF1] flex gap-3">
              <button className="flex-1 py-2 bg-[#16A34A]/10 hover:bg-[#16A34A]/20 text-[#16A34A] font-medium rounded-xl transition-colors">
                Mark Attendance
              </button>
            </div>
          </div>
