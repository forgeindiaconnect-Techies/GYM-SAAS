    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        {[
          ...
          { label: 'This Month Earnings', value: '₹2,450', icon: IndianRupee, color: 'text-[#164A4A]', bg: 'bg-[#164A4A]/10' },
        ].map((stat, i) => (
        ...
        <div className="md:col-span-2 bg-[#FFFFFF] border border-[#D3DFDA] rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center justify-between p-4 bg-[#FFFFFF] border border-[#D3DFDA] rounded-xl hover:border-[#164A4A]/50 transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#455250]">{session.type}</p>
                  </div>
                </div>
                <div className="text-right">
                  <div className="font-bold text-[#164A4A]">{session.time}</div>
                  <div className="text-xs text-[#455250]">{session.duration}</div>
                </div>
              </div>
            ))}
          </div>
