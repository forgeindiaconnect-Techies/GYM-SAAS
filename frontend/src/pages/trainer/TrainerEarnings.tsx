...
const TrainerEarnings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-[#202522]">Earnings</h1>
        <p className="text-[#727975] text-sm mt-1">Your earnings overview and payment status</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-5 shadow-sm col-span-2">
          <div className="flex items-center gap-2 mb-1">
            <IndianRupee size={16} className="text-[#34483F]" />
            <p className="text-xs font-semibold text-[#727975] uppercase tracking-wide">Current Fee</p>
          </div>
          {fee ? (
            <div className="flex items-end gap-2 mt-1">
              <span className="text-3xl font-bold text-[#202522]">₹{fee.feeAmount?.toLocaleString('en-IN')}</span>
              <span className="text-[#727975] text-sm mb-0.5">{cycleSuffix(fee.billingCycle)}</span>
            </div>
          ) : (
        ...
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-[#727975] uppercase tracking-wide">Total Earned</p>
          </div>
          <p className="text-2xl font-bold text-[#202522] mt-1">₹{(data?.trainer?.totalEarnings || 0).toLocaleString('en-IN')}</p>
        ...
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-[#727975] uppercase tracking-wide">Available</p>
          </div>
          <p className="text-2xl font-bold text-[#202522] mt-1">₹{(data?.trainer?.availableBalance || 0).toLocaleString('en-IN')}</p>
        ...
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-[#727975] uppercase tracking-wide">Pending</p>
          </div>
          <p className="text-2xl font-bold text-[#202522] mt-1">₹{(data?.trainer?.pendingWithdrawal || 0).toLocaleString('en-IN')}</p>
        ...
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-semibold text-[#727975] uppercase tracking-wide">Withdrawn</p>
          </div>
          <p className="text-2xl font-bold text-[#202522] mt-1">₹{(data?.trainer?.withdrawnAmount || 0).toLocaleString('en-IN')}</p>
      ...
      {fee && (
        <div className="bg-white border border-[#E8E5DA] rounded-2xl shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-[#E8E5DA]">
            <h2 className="font-bold text-[#202522]">Current Period Breakdown</h2>
          </div>
          <div className="p-6">
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-lg font-bold text-[#202522]">₹{fee.feeAmount?.toLocaleString('en-IN')}</p>
            ...
            {/* Progress bar */}
            <div className="mt-6">
              <div className="flex justify-between text-xs text-[#727975] mb-1.5">
              ...
              <div className="h-2 bg-[#F1F5F9] rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[#34483F] to-[#8FA89B] rounded-full transition-all"
      ...
      {fee && (
        <div className="flex justify-center mt-4">
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-white border border-[#E8E5DA] text-[#4A514D] font-semibold rounded-xl hover:bg-[#F2EFE8] hover:text-[#202522] transition-colors shadow-sm"
          >
            <Clock size={16} />
      ...
      {!fee && (
        <div className="bg-white border border-[#E8E5DA] rounded-2xl p-12 text-center shadow-sm">
          ...
          <h3 className="text-lg font-semibold text-[#4A514D]">No Fee Configured</h3>
