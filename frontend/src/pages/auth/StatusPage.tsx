...
const StatusPage = () => {
  ...
  const renderContent = () => {
    switch (type) {
      case 'rejected':
        return (
          <>
            ...
            <h1 className="text-3xl font-bold text-[#202522] mb-3 text-center">Application Rejected</h1>
            <p className="text-[#4A514D] max-w-md mb-6 leading-relaxed text-center mx-auto">
              {user?.role === 'MEMBER' 
            ...
            {user?.rejectionReason && (
              <div className="bg-[#FFFFFF] border border-red-500/30 rounded-2xl p-6 max-w-md w-full mb-8 text-left mx-auto">
                ...
                <p className="text-[#202522] text-sm">{user.rejectionReason}</p>
              </div>
            )}
            <div className="flex justify-center space-x-4 mb-8">
              <a href="mailto:support@aigym.com" className="px-6 py-2 bg-[#FFFFFF] border border-[#DCD9CD] hover:bg-[#333] text-[#202522] rounded-lg font-medium transition-colors">
                Contact Support
              </a>
            </div>
          </>
      ...
      case 'suspended':
        return (
          <>
            <div className="w-20 h-20 bg-[#8FA89B]/10 rounded-full flex items-center justify-center mb-8 mx-auto">
              <AlertTriangle size={40} className="text-[#8FA89B]" />
            </div>
            <h1 className="text-3xl font-bold text-[#202522] mb-3 text-center">Account Suspended</h1>
            <p className="text-[#4A514D] max-w-md mb-6 leading-relaxed text-center mx-auto">
              Your gym account has been suspended. Please contact the administrator for assistance.
            </p>
            {user?.suspensionReason && (
              <div className="bg-[#FFFFFF] border border-[#8FA89B]/30 rounded-2xl p-6 max-w-md w-full mb-8 text-left mx-auto">
                <h3 className="text-teal-400 font-semibold mb-2">Reason for Suspension:</h3>
                <p className="text-[#202522] text-sm">{user.suspensionReason}</p>
              </div>
            )}
            <div className="flex justify-center space-x-4 mb-8">
              <a href="mailto:support@aigym.com" className="px-6 py-2 bg-[#34483F] hover:bg-[#C6A77D] text-white rounded-lg font-medium transition-colors">
                Contact Support
              </a>
            </div>
          </>
      ...
      case 'inactive':
        return (
          <>
            ...
            <h1 className="text-3xl font-bold text-[#202522] mb-3 text-center">Account Inactive</h1>
            <p className="text-[#4A514D] max-w-md mb-6 leading-relaxed text-center mx-auto">
            ...
            <div className="flex justify-center space-x-4 mb-8">
              <a href="mailto:support@aigym.com" className="px-6 py-2 bg-[#FFFFFF] border border-[#DCD9CD] hover:bg-[#F5F3EE] text-[#202522] rounded-lg font-medium transition-colors">
                Contact Support
              </a>
            </div>
          </>
      ...
      default:
        return (
          <>
            ...
            <h1 className="text-3xl font-bold text-[#202522] mb-3 text-center">Application Pending Review</h1>
            <p className="text-[#4A514D] max-w-md mb-6 leading-relaxed text-center mx-auto">
              Hi <strong className="text-[#202522]">{user?.firstName}</strong>, 
              {user?.role === 'MEMBER'
            ...
            <div className="bg-[#FFFFFF] border border-[#DCD9CD] rounded-2xl p-6 max-w-sm w-full mb-8 space-y-4 text-left mx-auto">
  ...
  return (
    <div className="min-h-screen bg-[#F5F3EE] flex flex-col justify-center px-4 relative">
