...
const PendingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0FDFA] flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-3xl font-bold text-[#1E293B] mb-3">Application Pending Review</h1>
      <p className="text-[#475569] max-w-md mb-6 leading-relaxed">
        Hi <strong className="text-[#1E293B]">{user?.firstName}</strong>, your AI GYM account has been created. Our team is reviewing your application and will notify you once approved.
      </p>

      <div className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl p-6 max-w-sm w-full mb-8 space-y-4 text-left">
