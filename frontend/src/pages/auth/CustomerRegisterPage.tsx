...
const CustomerRegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0FDFA] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-2xl bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl shadow-2xl overflow-hidden z-10">
        {/* Progress Header */}
        <div className="bg-[#FFFFFF] border-b border-[#CCFBF1] px-8 py-5 flex items-center justify-between">
          <h1 className="text-xl font-bold text-[#1E293B]">Customer Registration</h1>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h2 className="text-lg font-semibold text-[#1E293B] mb-1">Fitness Preferences</h2>
              <div>
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Preferred Workout Type *</label>
                <div className="flex gap-2">
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Preferred Workout Days *</label>
                <div className="flex gap-2">
                  {WORKOUT_DAYS.map(d => (
