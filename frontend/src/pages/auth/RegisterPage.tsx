...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0FDFA] flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-2xl bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl shadow-2xl overflow-hidden">
        {/* Progress Header */}
        <div className="bg-[#FFFFFF] border-b border-[#CCFBF1] px-8 py-5">
          <h1 className="text-xl font-bold text-[#1E293B] mb-4">Create Your Account</h1>
          <div className="flex items-center space-x-2">
            {STEPS.map((s, i) => (
              <div key={i} className="flex items-center space-x-2">
                ...
                <span className={`text-xs hidden sm:block ${i === step ? 'text-[#1E293B] font-medium' : 'text-[#555]'}`}>{s}</span>
        ...
        <form onSubmit={handleSubmit} className="p-8">
          ...
          {step === 0 && (
            <div className="space-y-5">
              <h2 className="text-lg font-semibold text-[#1E293B] mb-1">Account Details</h2>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#475569] hover:text-[#1E293B]">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#475569] hover:text-[#1E293B]">
          ...
          {step === 1 && (
            <div className="space-y-5">
              <h2 className="text-lg font-semibold text-[#1E293B] mb-1">Personal Details</h2>
              <div className="grid grid-cols-2 gap-4">
                <div>
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Gender *</label>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h2 className="text-lg font-semibold text-[#1E293B] mb-1">Fitness Details</h2>
              <div>
                <label className="block text-sm text-[#475569] mb-3">Fitness Goal *</label>
                <div className="flex flex-wrap gap-2">
                  {FITNESS_GOALS.map(g => (
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Experience Level *</label>
                <div className="flex gap-2">
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Preferred Training</label>
                <div className="flex gap-2">
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Preferred Workout Time</label>
                <div className="flex flex-wrap gap-2">
                  {WORKOUT_TIMES.map(t => (
          ...
          {step === 3 && (
            <div className="space-y-5">
              <h2 className="text-lg font-semibold text-[#1E293B] mb-1">Emergency Contact</h2>
              <p className="text-[#475569] text-sm">In case of an emergency, we'll reach out to this person.</p>
              <div>
                <label className="block text-sm text-[#475569] mb-2">Full Name *</label>
              ...
              <div>
                <label className="block text-sm text-[#475569] mb-3">Relationship *</label>
                <div className="flex flex-wrap gap-2">
                  {RELATIONSHIPS.map(r => (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#475569]">I accept the <span className="text-[#16A34A]">Terms & Conditions</span></span>
                </label>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  ...
                  <span className="text-sm text-[#475569]">I accept the <span className="text-[#16A34A]">Privacy Policy</span></span>
                </label>
          ...
          {/* Navigation Buttons */}
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#CCFBF1]">
            {step > 0 ? (
              <button type="button" onClick={prev} className="flex items-center space-x-2 px-5 py-2.5 bg-[#FFFFFF] border border-[#CCFBF1] text-[#1E293B] rounded-xl hover:bg-[#202020] transition-colors text-sm">
                <ChevronLeft size={18} /><span>Back</span>
              </button>
            ) : (
              <Link to="/login" className="flex items-center space-x-2 px-5 py-2.5 bg-[#FFFFFF] border border-[#CCFBF1] text-[#1E293B] rounded-xl hover:bg-[#202020] transition-colors text-sm">
                <span>Back to Login</span>
              </Link>
            )}

            {step < STEPS.length - 1 ? (
              <button type="button" onClick={next} className="flex items-center space-x-2 px-6 py-2.5 bg-[#16A34A] text-[#1E293B] font-bold rounded-xl hover:bg-[#15803D] transition-colors text-sm">
                <span>Next</span><ChevronRight size={18} />
              </button>
            ) : (
              <button id="reg-submit" type="submit" disabled={isLoading} className="flex items-center space-x-2 px-6 py-2.5 bg-[#16A34A] text-[#1E293B] font-bold rounded-xl hover:bg-[#15803D] disabled:opacity-60 transition-colors text-sm">
