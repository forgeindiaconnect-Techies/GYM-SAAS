    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-[#455250]">Track your body metrics and achievements</p>
        </div>
      ...
      <div className="grid md:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="bg-[#FFFFFF] border border-[#D3DFDA] rounded-2xl p-5">
            <span className="text-sm text-[#455250]">{metric.label}</span>
            <div className="flex items-baseline gap-1 mt-1 mb-2">
              <span className="text-3xl font-bold">{metric.value}</span>
              <span className="text-[#455250]">{metric.unit}</span>
            </div>
      ...
      <div className="bg-[#FFFFFF] border border-[#D3DFDA] rounded-2xl p-8 flex flex-col items-center justify-center text-center min-h-[40vh]">
        <div className="w-16 h-16 bg-[#164A4A]/10 rounded-full flex items-center justify-center mb-4">
          <TrendingUp size={32} className="text-[#164A4A]" />
        </div>
