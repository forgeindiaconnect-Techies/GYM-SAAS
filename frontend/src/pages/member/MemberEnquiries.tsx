  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#1E293B] tracking-tight">My Enquiries</h1>
          <p className="text-[#475569] mt-1">Track the status of your queries sent to gyms.</p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#F8FAFC] border-b border-[#E2E8F0]">
                  <th className="px-6 py-4 text-xs font-semibold text-[#64748B] uppercase tracking-wider">Gym Details</th>
                  <th className="px-6 py-4 text-xs font-semibold text-[#64748B] uppercase tracking-wider">Enquiry Info</th>
                  <th className="px-6 py-4 text-xs font-semibold text-[#64748B] uppercase tracking-wider">Date Submitted</th>
                  ...
                  <tr key={enq._id} className="hover:bg-[#F8FAFC] transition-colors">
                    <td className="px-6 py-4">
                      <div className="font-semibold text-[#1E293B] flex items-center gap-1.5">
                        <Building2 size={14} className="text-[#16A34A]"/> {enq.gymId?.name || 'Unknown Gym'}
                      </div>
                      <div className="text-sm text-[#475569] flex items-center gap-1 mt-1">
                        <MapPin size={12}/> {enq.branchId?.name || enq.city || 'Main Branch'}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-semibold text-[#1E293B]">{enq.enquiryType}</div>
                      <div className="text-sm text-[#64748B] line-clamp-1 max-w-xs">{enq.message}</div>
                    </td>
                    <td className="px-6 py-4">
