...
const MemberChat = () => {
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-[#FFFFFF] border border-[#CCFBF1] rounded-2xl p-10 flex flex-col items-center justify-center text-center min-h-[60vh]">
        <div className="w-20 h-20 bg-[#16A34A]/10 rounded-full flex items-center justify-center mb-6">
          <MessageSquare size={40} className="text-[#16A34A]" />
        </div>
        <h2 className="text-2xl font-bold text-[#1E293B] mb-2">Trainer Messages</h2>
