      ...
      <div className="bg-[#FFFFFF] rounded-2xl max-w-3xl w-full shadow-2xl border border-[#CCFBF1] overflow-hidden my-8 shrink-0">
        <div className="p-6 border-b border-[#CCFBF1] flex justify-between items-center bg-[#F8FAFC]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#1E293B]">Add Existing Customer</h2>
              <p className="text-sm text-[#475569] mt-1">Import a member who is already part of your physical gym.</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-8">
          ...
          {/* Personal Info */}
          <div>
            <h3 className="text-sm font-bold text-[#16A34A] uppercase tracking-wider mb-4 border-b border-[#CCFBF1] pb-2">Personal Information</h3>
          ...
          {/* Membership Details */}
          <div>
            <h3 className="text-sm font-bold text-[#16A34A] uppercase tracking-wider mb-4 border-b border-[#CCFBF1] pb-2">Membership Details</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
              ...
              <div>
                <label className="block text-sm font-bold text-[#475569] mb-1">Membership End Date (Optional)</label>
                <input type="date" value={formData.endDate} onChange={e => setFormData({...formData, endDate: e.target.value})} className="w-full bg-[#F8FAFC] border border-[#CCFBF1] rounded-xl px-4 py-2.5 outline-none focus:border-[#16A34A] focus:bg-[#FFFFFF]" />
              </div>
          ...
          {/* Emergency Contact */}
          <div>
            <h3 className="text-sm font-bold text-[#16A34A] uppercase tracking-wider mb-4 border-b border-[#CCFBF1] pb-2">Emergency Contact</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-bold text-[#475569] mb-1">Contact Name</label>
                <input value={formData.emergencyName} onChange={e => setFormData({...formData, emergencyName: e.target.value})} className="w-full bg-[#F8FAFC] border border-[#CCFBF1] rounded-xl px-4 py-2.5 outline-none focus:border-[#16A34A] focus:bg-[#FFFFFF]" placeholder="Name" />
              </div>
              <div>
              ...
              <div>
                ...
                <input value={formData.emergencyRelation} onChange={e => setFormData({...formData, emergencyRelation: e.target.value})} className="w-full bg-[#F8FAFC] border border-[#CCFBF1] rounded-xl px-4 py-2.5 outline-none focus:border-[#16A34A] focus:bg-[#FFFFFF]" placeholder="e.g. Spouse" />
              </div>
            </div>
          </div>
          ...
          {/* Account Setup */}
          <div>
            <h3 className="text-sm font-bold text-[#16A34A] uppercase tracking-wider mb-4 border-b border-[#CCFBF1] pb-2">Account Setup</h3>
            <div className="flex flex-col space-y-3">
              <label className="flex items-center space-x-3 cursor-pointer">
                ...
                <span className="text-[#1E293B] font-medium">Create Member Login Account</span>
              </label>
              <label className="flex items-center space-x-3 cursor-pointer">
                ...
                <span className="text-[#1E293B] font-medium">Send Welcome Email & Invitation</span>
              </label>
            </div>
          </div>

          <div className="flex justify-end space-x-3 pt-6 border-t border-[#CCFBF1]">
            <button type="button" onClick={onClose} className="px-6 py-2.5 text-[#475569] font-bold hover:bg-gray-100 rounded-xl transition-colors">Cancel</button>
            <button type="submit" className="px-8 py-2.5 bg-[#16A34A] text-white rounded-xl font-bold hover:bg-[#15803D] transition-colors shadow-lg shadow-[#16A34A]/20 flex items-center gap-2">
