  ...
  if (journey === 'select') {
    return (
      <div className="flex flex-col md:flex-row items-stretch justify-center gap-8 w-full max-w-4xl mx-auto h-full animate-in fade-in zoom-in duration-500">
        <div onClick={() => setJourney('customer')} className="flex-1 w-full bg-[#202828] border-2 border-[#334155] rounded-3xl p-8 hover:border-[#164A4A] hover:bg-[#202828]/80 transition-all cursor-pointer group shadow-xl flex flex-col">
          <div className="w-16 h-16 bg-[#164A4A]/20 rounded-2xl flex items-center justify-center text-[#164A4A] mb-6 group-hover:scale-110 transition-transform">
            <User size={32} />
          </div>
          <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-[#164A4A] transition-colors">Customer Journey</h3>
          ...
          <ul className="space-y-3 mb-8 flex-1">
            {['Join a gym', 'Create fitness profile', 'Get AI recommendations', 'Connect with trainers', 'Track progress'].map((item, idx) => (
              <li key={idx} className="flex items-center text-sm text-[#CBD5E1]"><CheckCircle size={16} className="text-[#164A4A] mr-2" /> {item}</li>
            ))}
          </ul>
          <div className="inline-flex items-center gap-2 text-[#164A4A] font-bold">Start Journey <ArrowRight size={16} /></div>
        </div>

        <div onClick={() => setJourney('owner')} className="flex-1 w-full bg-[#202828] border-2 border-[#334155] rounded-3xl p-8 hover:border-[#6fa3a0] hover:bg-[#202828]/80 transition-all cursor-pointer group shadow-xl flex flex-col">
          <div className="w-16 h-16 bg-[#6fa3a0]/20 rounded-2xl flex items-center justify-center text-[#6fa3a0] mb-6 group-hover:scale-110 transition-transform">
            <Activity size={32} />
          </div>
          <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-[#6fa3a0] transition-colors">Gym Owner Journey</h3>
          ...
          <ul className="space-y-3 mb-8 flex-1">
            {['Register gym', 'Get Superadmin approval', 'Choose SaaS subscription', 'Complete payment', 'Access Dashboard'].map((item, idx) => (
              <li key={idx} className="flex items-center text-sm text-[#CBD5E1]"><CheckCircle size={16} className="text-[#6fa3a0] mr-2" /> {item}</li>
            ))}
          </ul>
          <div className="inline-flex items-center gap-2 text-[#6fa3a0] font-bold">Start Journey <ArrowRight size={16} /></div>
        </div>
      </div>
    );
  }
    ...
    const customerSteps = [
      {
        ...
        render: () => (
          <div className="w-full max-w-lg bg-white rounded-2xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-10">
            <h4 className="text-xl font-bold text-[#202828] mb-4">Create Profile</h4>
            ...
            <button className="w-full bg-[#164A4A] text-white py-3 rounded-xl font-bold">Complete Registration</button>
          </div>
        )
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-2xl bg-white rounded-2xl p-8 shadow-2xl animate-in fade-in zoom-in">
            <div className="flex items-center justify-between mb-8 relative">
               ...
               <div className="absolute top-1/2 left-0 w-[80%] h-1 bg-[#164A4A] -z-10 -translate-y-1/2 transition-all duration-1000"></div>
               {[
                 ...
                 <div key={i} className="flex flex-col items-center bg-white px-2">
                   <div className={`w-12 h-12 rounded-full flex items-center justify-center border-4 border-white ${s.active ? 'bg-[#164A4A] text-white' : 'bg-[#E8E5DA] text-[#A8ADA9]'}`}><s.icon size={20}/></div>
                   <span className="text-xs font-bold mt-2 text-[#455250]">{s.label}</span>
                 </div>
               ))}
            </div>
            <div className="bg-[#F2EFE8] border border-[#E8E5DA] rounded-xl p-6 text-center max-w-sm mx-auto">
               <h4 className="font-bold text-[#202828] mb-2">Welcome Back</h4>
               <p className="text-xs text-[#455250] mb-4">Once your registration is approved, sign in to access your personalized dashboard.</p>
               ...
               <button className="w-full bg-[#164A4A] text-white py-2 rounded font-bold">Sign In</button>
            </div>
          </div>
        )
      },
        ...
        render: () => (
          <div className="w-full max-w-3xl bg-[#F2EFE8] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-right-10 flex flex-col h-[500px]">
            <div className="bg-white p-4 border-b border-[#E8E5DA] flex justify-between items-center shrink-0">
               <div>
                 <h4 className="font-bold text-[#202828] text-lg">Welcome back, Alex!</h4>
                 <p className="text-xs text-[#455250]">Premium Member at Iron Forge Barbell</p>
               </div>
               <div className="w-10 h-10 bg-[#164A4A]/10 text-[#164A4A] rounded-full flex items-center justify-center"><User size={20}/></div>
            </div>
            <div className="p-6 grid grid-cols-3 gap-4 overflow-y-auto">
               <div className="col-span-2 space-y-4">
                 <div className="bg-white p-4 rounded-xl border border-[#E8E5DA] flex justify-between items-center shadow-sm">
                   <div>
                     <h5 className="font-bold text-sm text-[#202828]">Today's Workout</h5>
                     <p className="text-xs text-[#164A4A] font-semibold">Upper Body Hypertrophy • 45 mins</p>
                   </div>
                   <button className="bg-[#202828] text-white px-4 py-2 rounded-lg text-sm font-bold">Start</button>
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                   <div className="bg-white p-4 rounded-xl border border-[#E8E5DA] shadow-sm">
                     ...
                     <div className="text-2xl font-bold text-[#202828]">12/15 <span className="text-sm text-[#A8ADA9] font-normal">days</span></div>
                   </div>
                   <div className="bg-white p-4 rounded-xl border border-[#E8E5DA] shadow-sm">
                     ...
                     <div className="text-2xl font-bold text-[#202828]">-2.5 <span className="text-sm text-[#A8ADA9] font-normal">kg</span></div>
                   </div>
                 </div>
               </div>
               <div className="col-span-1 space-y-4">
                 <div className="bg-white p-4 rounded-xl border border-[#E8E5DA] shadow-sm">
                   <h5 className="font-bold text-sm text-[#202828] mb-3">AI Diet Goal</h5>
                   <div className="relative w-24 h-24 mx-auto mb-2">
                     <svg className="w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                       ...
                       <path className="text-[#164A4A]" strokeDasharray="65, 100" strokeWidth="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"/>
                     </svg>
                     <div className="absolute inset-0 flex flex-col items-center justify-center">
                       <span className="font-bold text-sm">1850</span>
                       <span className="text-[10px] text-[#455250]">kcal</span>
                     </div>
                   </div>
                 </div>
               </div>
      ...
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-8 relative overflow-hidden animate-in zoom-in duration-700">
             <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#164A4A]/5 to-transparent"></div>
             <div className="relative z-10 flex flex-col items-center">
               <div className="w-20 h-20 bg-white border border-[#164A4A]/30 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(22,163,74,0.3)] mb-6 animate-pulse">
                 <Bot size={40} className="text-[#164A4A]" />
               </div>
               <div className="grid grid-cols-4 gap-4 w-full mb-8 text-center">
                 {['Height: 180cm', 'Weight: 75kg', 'Goal: Muscle', 'Level: Mid'].map((t, i) => (
                   <div key={i} className="bg-[#F2EFE8] py-2 px-3 rounded-lg border border-[#E8E5DA] text-xs font-bold text-[#455250]">{t}</div>
                 ))}
               </div>
               <div className="w-full space-y-3">
                 <div className="h-2 w-full bg-[#E8E5DA] rounded-full overflow-hidden"><div className="h-full bg-[#164A4A] w-[100%] transition-all duration-1000 ease-out"></div></div>
                 <div className="flex justify-between text-xs font-bold text-[#202828]"><span>Analyzing Profile...</span><span>100%</span></div>
               </div>
               <div className="mt-8 grid grid-cols-2 gap-4 w-full">
                 <div className="bg-[#F1F5F3] border border-[#D3DFDA] p-4 rounded-xl">
                   <h5 className="font-bold text-sm text-[#6fa3a0] mb-1">Recommended Approach</h5>
                   <p className="text-xs text-[#455250]">4-day upper/lower split focusing on progressive overload.</p>
                 </div>
                 <div className="bg-[#F1F5F3] border border-[#D3DFDA] p-4 rounded-xl">
                   <h5 className="font-bold text-sm text-[#6fa3a0] mb-1">Diet Guidance</h5>
                   <p className="text-xs text-[#455250]">Caloric surplus of 300kcal with 160g daily protein target.</p>
                 </div>
               </div>
             </div>
          </div>
        ...
        render: () => (
          <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl p-6 flex flex-col h-[500px] animate-in fade-in">
             <div className="flex justify-between items-center mb-6 border-b border-[#E8E5DA] pb-4">
               <h4 className="font-bold text-lg text-[#202828]">Weekly Plan</h4>
               <div className="flex space-x-2">
                 {['M', 'T', 'W', 'T', 'F', 'S', 'S'].map((d, i) => (
                   <div key={i} className={`w-8 h-8 flex items-center justify-center rounded-full text-xs font-bold ${i === 0 ? 'bg-[#202828] text-white' : i === 3 || i === 6 ? 'bg-[#F2EFE8] text-[#A8ADA9] border border-[#E8E5DA]' : 'bg-[#F1F5F3] text-[#6fa3a0]'}`}>
                     {d}
                   </div>
                 ))}
               </div>
             ...
             <div className="flex-1 overflow-y-auto pr-2 space-y-4">
               {[
                 ...
                 <div key={i} className="bg-[#F2EFE8] border border-[#E8E5DA] p-4 rounded-xl flex gap-4 hover:border-[#164A4A] transition-colors">
                   ...
                   <div className="flex-1">
                     <div className="flex justify-between mb-1">
                       <h5 className="font-bold text-[#202828] text-sm">{ex.name}</h5>
                       <span className="text-xs px-2 py-0.5 bg-[#F1F5F3] text-[#6fa3a0] rounded-md font-semibold">{ex.target}</span>
                     </div>
                     <p className="text-xs text-[#164A4A] font-bold mb-1">{ex.sets}</p>
                     <p className="text-xs text-[#455250]">{ex.desc}</p>
                   </div>
                 </div>
               ))}
             </div>
        ...
        render: () => (
          <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl p-6 flex flex-col h-[500px] animate-in fade-in">
             ...
             <div className="flex justify-between items-center mb-4">
               <div className="text-2xl font-black text-[#202828]">2,450 <span className="text-sm text-[#455250] font-medium">kcal/day</span></div>
               <div className="flex gap-4">
                 <div className="text-center"><div className="text-xs text-[#455250]">Protein</div><div className="font-bold text-[#D2B48C]">160g</div></div>
                 <div className="text-center"><div className="text-xs text-[#455250]">Carbs</div><div className="font-bold text-[#164A4A]">240g</div></div>
                 <div className="text-center"><div className="text-xs text-[#455250]">Fats</div><div className="font-bold text-yellow-600">70g</div></div>
               </div>
             </div>
             <div className="flex-1 overflow-y-auto space-y-3">
               {[
                 ...
                 <div key={i} className="flex justify-between items-center p-4 bg-[#F2EFE8] border border-[#E8E5DA] rounded-xl">
                   <div>
                     <h5 className="font-bold text-sm text-[#202828]">{m.meal} <span className="text-xs text-[#A8ADA9] font-normal ml-2">{m.time}</span></h5>
                     <p className="text-xs text-[#455250] mt-1">{m.items}</p>
                   </div>
                   <div className="font-bold text-sm text-[#164A4A]">{m.kcal}</div>
                 </div>
               ))}
             </div>
          </div>
        ...
        render: () => (
          <div className="w-full max-w-4xl bg-transparent animate-in zoom-in flex flex-col md:flex-row gap-6 justify-center">
            <div className="bg-white rounded-2xl shadow-xl p-6 flex-1 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-[#D2B48C] mb-4"><Monitor size={24}/></div>
              <h4 className="font-bold text-lg mb-2">Online Trainer</h4>
              <p className="text-xs text-[#455250] mb-6">Get remote video guidance, diet tracking, and workout adjustments anywhere.</p>
              <div className="bg-[#F2EFE8] border border-[#E8E5DA] p-4 rounded-xl w-full text-left">
                ...
                <button className="w-full py-2 bg-[#202828] text-white text-xs font-bold rounded-lg mt-2">Connect via Chat</button>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-xl p-6 flex-1 flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center text-[#164A4A] mb-4"><MapPin size={24}/></div>
              <h4 className="font-bold text-lg mb-2">Offline Trainer</h4>
              <p className="text-xs text-[#455250] mb-6">In-person form correction, spotting, and personalized motivation at your gym.</p>
              <div className="bg-[#F2EFE8] border border-[#E8E5DA] p-4 rounded-xl w-full text-left">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div><h5 className="font-bold text-sm">Sarah Miller</h5><span className="text-[10px] bg-[#D2B48C]/10 text-[#164A4A] px-1.5 py-0.5 rounded">At Iron Forge</span></div>
                </div>
                <button className="w-full py-2 bg-[#164A4A] text-white text-xs font-bold rounded-lg mt-2">Book Session</button>
              </div>
            </div>
          </div>
        )
        ...
        render: () => (
          <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[450px] animate-in fade-in">
             <div className="w-full md:w-1/2 bg-[#F2EFE8] p-6 border-r border-[#E8E5DA] flex flex-col justify-center">
               <h4 className="font-bold text-lg text-[#202828] mb-4">Interactive Support</h4>
               <ul className="space-y-4">
                 {[
                   ...
                   <li key={i} className="flex gap-3">
                     <div className="w-8 h-8 rounded-full bg-[#164A4A]/10 text-[#164A4A] flex items-center justify-center shrink-0"><item.icon size={16}/></div>
                     <div><h5 className="font-bold text-sm text-[#202828]">{item.title}</h5><p className="text-xs text-[#455250]">{item.desc}</p></div>
                   </li>
                 ))}
               </ul>
             </div>
             <div className="w-full md:w-1/2 bg-white p-6 flex flex-col">
               <div className="flex-1 overflow-y-auto space-y-4">
                 <div className="flex gap-3">
                   ...
                   <div className="bg-[#F2EFE8] p-3 rounded-xl rounded-tl-none border border-[#E8E5DA] text-sm text-[#202828]"><p>Great job on the deadlifts! Next week, let's increase the weight by 5kg.</p></div>
                 </div>
                 <div className="flex gap-3 flex-row-reverse">
                   ...
                   <div className="bg-[#164A4A] p-3 rounded-xl rounded-tr-none text-white text-sm"><p>Sounds good! Though my left shoulder feels slightly tight during bench press.</p></div>
                 </div>
                 <div className="flex gap-3">
                   <div className="w-8 h-8 rounded-full bg-blue-100 shrink-0 overflow-hidden"><img src="https://images.unsplash.com/photo-1594381898411-846e7d193883?w=100&q=80"/></div>
                   <div className="bg-[#F2EFE8] p-3 rounded-xl rounded-tl-none border border-[#E8E5DA] text-sm text-[#202828]">
                     <p className="mb-2">Let's modify that. I've updated your plan to use Dumbbell Presses instead to allow free rotation.</p>
                     <div className="bg-white border border-[#E8E5DA] rounded p-2 text-xs flex items-center gap-2"><Dumbbell size={14} className="text-[#164A4A]"/><span className="font-bold">Plan Updated</span></div>
                   </div>
                 </div>
               </div>
             </div>
      ...
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-3xl flex flex-col md:flex-row gap-6 animate-in slide-in-from-bottom-10">
            <div className="flex-1 bg-white rounded-2xl shadow-xl p-6 flex flex-col items-center justify-center border-t-4 border-[#164A4A]">
              ...
              <h4 className="font-bold text-2xl text-[#202828] mb-1">Workout Complete!</h4>
              <p className="text-sm text-[#455250] mb-6">Upper Body Hypertrophy</p>
              <div className="flex gap-4 w-full justify-center text-center border-t border-[#E8E5DA] pt-4">
                <div><div className="font-black text-xl text-[#202828]">45m</div><div className="text-xs text-[#A8ADA9]">Duration</div></div>
                <div><div className="font-black text-xl text-[#202828]">12k</div><div className="text-xs text-[#A8ADA9]">Volume</div></div>
              </div>
            </div>
            <div className="flex-1 flex flex-col gap-4">
              <div className="bg-white rounded-2xl shadow-xl p-5 border border-[#E8E5DA] flex items-center gap-4">
                ...
                <div><h5 className="font-bold text-[#202828]">4 Day Streak!</h5><p className="text-xs text-[#455250]">You're on fire this week.</p></div>
              </div>
              <div className="bg-white rounded-2xl shadow-xl p-5 border border-[#E8E5DA] flex items-center gap-4">
                <div className="w-12 h-12 bg-blue-100 text-blue-500 rounded-xl flex items-center justify-center"><Calendar size={24}/></div>
                <div><h5 className="font-bold text-[#202828]">Attendance Logged</h5><p className="text-xs text-[#455250]">Iron Forge Barbell at 5:30 PM</p></div>
              </div>
            </div>
          </div>
        )
        ...
        render: () => (
          <div className="w-full max-w-3xl bg-white rounded-2xl shadow-2xl p-6 h-[450px] flex flex-col animate-in zoom-in">
             <div className="flex justify-between items-center mb-6">
               <h4 className="font-bold text-lg text-[#202828]">Weight Trend</h4>
               <div className="bg-gray-100 p-1 rounded-lg text-xs font-semibold text-[#455250] flex gap-1">
             ...
             <div className="flex-1 relative border-l border-b border-[#E8E5DA] ml-6 mb-6">
               ...
               <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                 <polyline points="0,20 20,25 40,35 60,45 80,50 100,65" fill="none" stroke="#164A4A" strokeWidth="2" vectorEffect="non-scaling-stroke" />
                 <polyline points="0,100 0,20 20,25 40,35 60,45 80,50 100,65 100,100" fill="rgba(22,163,74,0.1)" stroke="none" />
                 
                 <circle cx="0" cy="20" r="2" fill="#164A4A" />
                 <circle cx="20" cy="25" r="2" fill="#164A4A" />
                 <circle cx="40" cy="35" r="2" fill="#164A4A" />
                 <circle cx="60" cy="45" r="2" fill="#164A4A" />
                 <circle cx="80" cy="50" r="2" fill="#164A4A" />
                 <circle cx="100" cy="65" r="2" fill="#164A4A" />
               </svg>
               <div className="absolute top-[20%] -left-12 text-[10px] text-[#A8ADA9]">80 kg</div>
               <div className="absolute top-[65%] -left-12 text-[10px] text-[#164A4A] font-bold">75 kg</div>
      ...
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-4xl flex flex-col md:flex-row gap-6 animate-in slide-in-from-bottom-10">
             <div className="flex-1 bg-gradient-to-br from-[#202828] to-[#0F172A] border border-[#334155] rounded-2xl p-6 text-white shadow-xl">
               <div className="w-12 h-12 bg-[#164A4A]/20 rounded-xl flex items-center justify-center text-[#164A4A] mb-4"><Bot size={24}/></div>
               <h4 className="font-bold text-xl mb-4">AI Coach</h4>
               <ul className="space-y-3 text-sm text-[#CBD5E1]">
                 <li className="flex gap-2 items-center"><Activity size={16} className="text-[#164A4A]"/> Analyzes millions of data points</li>
                 <li className="flex gap-2 items-center"><TrendingUp size={16} className="text-[#164A4A]"/> Creates optimized recommendations</li>
                 <li className="flex gap-2 items-center"><MapPin size={16} className="text-[#164A4A]"/> Tracks patterns automatically</li>
                 <li className="flex gap-2 items-center"><CheckCircle size={16} className="text-[#164A4A]"/> Updates suggestions instantly</li>
               </ul>
             </div>
             ...
             <div className="flex-1 bg-white border border-[#E8E5DA] rounded-2xl p-6 shadow-xl">
               <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-[#D2B48C] mb-4"><User size={24}/></div>
               <h4 className="font-bold text-xl text-[#202828] mb-4">Human Trainer</h4>
               <ul className="space-y-3 text-sm text-[#455250]">
      ...
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-6 animate-in zoom-in">
             <div className="bg-gradient-to-r from-[#164A4A] to-[#6fa3a0] rounded-xl p-6 text-white mb-6 shadow-lg relative overflow-hidden">
             ...
             <h5 className="font-bold text-[#202828] mb-3">Subscription Details</h5>
             <div className="bg-[#F2EFE8] border border-[#E8E5DA] rounded-xl overflow-hidden text-sm">
               <div className="flex justify-between p-3 border-b border-[#E8E5DA]"><span className="text-[#455250]">Plan</span><span className="font-bold">Monthly Billed</span></div>
               <div className="flex justify-between p-3 border-b border-[#E8E5DA]"><span className="text-[#455250]">Amount</span><span className="font-bold">₹1,499 / mo</span></div>
               <div className="flex justify-between p-3"><span className="text-[#455250]">Payment Method</span><span className="font-bold flex items-center gap-2"><CreditCard size={14}/> •••• 4242</span></div>
             </div>
          </div>
        )
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-2xl flex flex-col items-center animate-in fade-in slide-in-from-bottom-10">
            <div className="w-24 h-24 bg-gradient-to-br from-[#164A4A] to-[#6fa3a0] rounded-full flex items-center justify-center text-white mb-6 shadow-xl shadow-green-900/20">
              <Activity size={48} />
            </div>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full mb-8">
              {['AI Fitness Analysis', 'Personalized Workout', 'Diet Guidance', 'Human Trainer Support', 'Attendance Tracking', 'Progress Tracking'].map((item, i) => (
                <div key={i} className="bg-[#202828] border border-[#334155] p-3 rounded-lg flex items-center gap-2 text-white text-xs font-bold shadow-sm">
                  <CheckCircle size={14} className="text-[#164A4A] shrink-0" /> {item}
                </div>
              ))}
            </div>
            <button onClick={() => setJourney('select')} className="px-8 py-4 bg-[#164A4A] hover:bg-[#C6A77D] text-white rounded-xl font-black text-lg transition-transform hover:scale-105 shadow-[0_0_40px_rgba(22,163,74,0.4)]">
              Back to Start
            </button>
          </div>
        )
    ...
    const ownerSteps = [
      {
        ...
        render: () => (
          <div className="w-full max-w-lg bg-white rounded-2xl p-6 shadow-2xl animate-in fade-in slide-in-from-bottom-10">
            <h4 className="text-xl font-bold text-[#202828] mb-4">Register as Partner</h4>
            ...
            <button className="w-full bg-[#202828] text-white py-3 rounded-xl font-bold">Continue to Gym Details</button>
          </div>
        )
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-6 animate-in zoom-in h-[450px] flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-2">
              <div>
                <h5 className="text-sm font-bold text-[#202828] mb-2">Facilities & Tags</h5>
                <div className="flex flex-wrap gap-2">
                  {['Cardio Section', 'Free Weights', 'CrossFit', 'AC', '24/7 Access', 'Sauna'].map((tag, i) => (
                    <span key={i} className="bg-[#164A4A]/10 text-[#164A4A] border border-[#164A4A]/30 px-3 py-1 rounded-full text-xs font-bold">{tag}</span>
                  ))}
                </div>
              </div>
              <div>
                <h5 className="text-sm font-bold text-[#202828] mb-2">Current Offers</h5>
        ...
        render: () => (
          <div className="w-full max-w-xl bg-white rounded-2xl shadow-2xl p-8 animate-in fade-in slide-in-from-right-10">
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-xl font-bold text-[#202828] mb-2">Under Review</h4>
              <p className="text-sm text-[#455250] text-center mb-8">Your application for <span className="font-bold text-[#202828]">Iron Forge Barbell</span> is being reviewed by our team. This usually takes 1-2 hours.</p>
              ...
              <div className="w-full bg-[#F2EFE8] border border-[#E8E5DA] rounded-xl p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center bg-white p-2 border border-[#E8E5DA] rounded shadow-sm"><span className="text-xs font-semibold">Rejected / Suspended</span> <XCircle size={14} className="text-[#6fa3a0]"/></div>
                </div>
              </div>
            </div>
          </div>
        ...
        render: () => (
          <div className="w-full max-w-4xl bg-transparent flex flex-col md:flex-row gap-6 animate-in zoom-in">
            <div className="bg-white rounded-2xl p-6 shadow-xl flex-1 border border-[#E8E5DA]">
              <div className="inline-block bg-[#164A4A] text-white text-[10px] font-bold px-2 py-1 rounded mb-4">GOLD PLAN</div>
              <div className="text-3xl font-black text-[#202828] mb-1">₹1,499<span className="text-sm text-[#455250] font-normal">/mo</span></div>
              <p className="text-xs text-[#455250] mb-4">For growing gyms</p>
              <ul className="space-y-2 text-xs mb-6">
                <li className="flex gap-2 items-center"><CheckCircle size={14} className="text-[#164A4A]"/> 500 members</li>
                <li className="flex gap-2 items-center"><CheckCircle size={14} className="text-[#164A4A]"/> 15 trainers</li>
                <li className="flex gap-2 items-center"><CheckCircle size={14} className="text-[#164A4A]"/> Detailed Analytics</li>
                <li className="flex gap-2 items-center"><CheckCircle size={14} className="text-[#164A4A]"/> Trainer Booking System</li>
              </ul>
              <button className="w-full py-2 bg-[#202828] text-white rounded-lg text-sm font-bold">Select Gold</button>
            </div>
            <div className="bg-gradient-to-b from-[#202828] to-[#0F172A] rounded-2xl p-6 shadow-2xl flex-1 border border-[#334155] transform md:-translate-y-4 md:scale-105">
        ...
        render: () => (
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-8 animate-in slide-in-from-bottom-10 flex flex-col items-center">
            <div className="w-full bg-[#F2EFE8] border border-[#E8E5DA] p-4 rounded-xl mb-6 flex justify-between items-center">
              <div>
                <h5 className="font-bold text-[#202828]">Premium Plan (Annual)</h5>
                <p className="text-xs text-[#164A4A]">Includes 2 months free</p>
              </div>
              <div className="text-lg font-black text-[#202828]">₹22,490</div>
            </div>
            ...
            <div className="relative w-full mb-8">
              ...
              <div className="relative w-full bg-white border border-green-500 rounded-xl p-6 text-center shadow-lg">
                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center text-[#164A4A] mx-auto mb-4">
                  <ShieldCheck size={32}/>
                </div>
                <h4 className="text-xl font-bold text-[#202828] mb-2">Payment Successful!</h4>
                <p className="text-sm text-[#455250]">Your gym is now live on the AI GYM platform.</p>
              </div>
            </div>
            
            <button className="w-full py-3 bg-[#164A4A] text-white font-bold rounded-xl shadow-lg">Go to Dashboard</button>
          </div>
        )
      },
      {
        ...
        render: () => (
          <div className="w-full max-w-4xl bg-[#F2EFE8] rounded-2xl shadow-2xl p-4 md:p-6 flex flex-col h-[500px] animate-in zoom-in border border-[#E8E5DA]">
            <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-xl shadow-sm border border-[#E8E5DA]">
              <div><h4 className="font-bold text-[#202828]">Iron Forge Barbell</h4><span className="text-xs bg-purple-100 text-purple-700 px-2 py-0.5 rounded font-bold">Premium Plan</span></div>
              <div className="text-right"><div className="text-xs text-[#A8ADA9]">Monthly Revenue</div><div className="font-black text-xl text-[#164A4A]">₹4,25,000</div></div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              {[
                ...
                <div key={i} className="bg-white p-4 rounded-xl shadow-sm border border-[#E8E5DA]">
                  ...
                  <div className="text-2xl font-black text-[#202828]">{c.val}</div>
            ...
            <div className="flex-1 bg-white rounded-xl shadow-sm border border-[#E8E5DA] p-4 flex items-center justify-center text-center">
               <div>
                 ...
                 <p className="text-sm font-bold text-[#455250]">Detailed Analytics & Charts Area</p>
               </div>
            </div>
          </div>
        )
          ...
          <div className="w-full max-w-3xl flex flex-col items-center animate-in fade-in slide-in-from-bottom-10">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 w-full mb-8">
              {[
                ...
                <div key={i} className="bg-[#202828] border border-[#334155] p-4 rounded-xl flex flex-col items-center justify-center text-center gap-2 hover:border-[#164A4A] transition-colors shadow-lg group">
                  <div className="w-10 h-10 bg-[#334155] rounded-full flex items-center justify-center group-hover:bg-[#164A4A]/20 transition-colors">
                    <item.icon size={20} className="text-white group-hover:text-[#164A4A]" />
                  </div>
