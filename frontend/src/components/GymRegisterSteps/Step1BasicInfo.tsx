  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-[#202828] border-b border-[#D3DFDA] pb-2">Owner Details</h2>
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            {!form.emailOtpVerified && (
              <button type="button" onClick={handleSendOtp} className="px-4 py-2 bg-[#F1F5F9] text-[#455250] text-sm font-medium rounded-xl border border-[#CBD5E1] hover:bg-[#E8E5DA] transition-colors whitespace-nowrap">
                {otpSent ? 'Resend OTP' : 'Send OTP'}
              </button>
            )}
            {form.emailOtpVerified && (
              <span className="px-4 py-2 bg-green-50 text-[#164A4A] text-sm font-medium rounded-xl border border-green-200 flex items-center gap-1 whitespace-nowrap">
          ...
          {otpSent && !form.emailOtpVerified && (
            <div className="mt-3 flex gap-2">
              <input 
                ...
                className="w-full px-4 py-2 bg-[#F2EFE8] border border-[#CBD5E1] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#164A4A] flex-1"
              />
              <button type="button" onClick={handleVerifyOtp} className="px-4 py-2 bg-[#164A4A] text-white text-sm font-medium rounded-xl hover:bg-[#C6A77D] transition-colors whitespace-nowrap">
                Verify
              </button>
            </div>
          )}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#455250]">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#455250]">
      ...
      {/* Gym Information */}
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-[#202828] border-b border-[#D3DFDA] pb-2">Gym Information</h2>
        <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm text-[#455250] mb-2">Gym Contact Number *</label>
      ...
      {/* Operational Details */}
      <div className="space-y-4">
        <h2 className="text-lg font-semibold text-[#202828] border-b border-[#D3DFDA] pb-2">Operational Details</h2>
        <div>
        ...
        <div>
          <label className="block text-sm text-[#455250] mb-2">Operating Hours *</label>
          <div className="flex flex-wrap gap-2">
        ...
        {/* Training Mode */}
        <div>
          <label className="block text-sm text-[#455250] mb-1">Training Mode *</label>
          <p className="text-xs text-[#A8ADA9] mb-2">Select how your gym provides trainer-led fitness services.</p>
          <div className="flex flex-wrap gap-2">
            {[
        ...
        {/* Services Offered */}
        <div>
          <label className="block text-sm text-[#455250] mb-2">Services Offered *</label>
          <div className="grid grid-cols-2 gap-3 p-4 border border-[#D3DFDA] rounded-xl bg-[#F2EFE8]">
            {(form.trainingMode === 'online' 
              ...
              <label key={service} className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="rounded text-[#164A4A] focus:ring-[#164A4A] border-[#CBD5E1]"
                />
                <span className="text-sm text-[#202828]">{service}</span>
              </label>
            ))}
          </div>
        ...
        <div>
          <label className="block text-sm text-[#455250] mb-2">Rating *</label>
        ...
        <div>
          <label className="block text-sm text-[#455250] mb-2">Gym Photo/Logo (Optional)</label>
          <div className="flex items-center gap-4">
            {form.logo && (
              <img src={form.logo} alt="Gym Logo" className="w-16 h-16 rounded-xl object-cover border border-[#D3DFDA]" />
            )}
            <input 
              type="file" 
              accept="image/*" 
              ...
              className="text-sm text-[#455250] file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-[#164A4A] file:text-black hover:file:bg-[#DC2626] transition-colors"
            />
          </div>
        </div>
      </div>
