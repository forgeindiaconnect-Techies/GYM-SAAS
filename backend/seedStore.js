  ...
  .then(async () => {
    ...
    const productsData = [
      ...
      },
      {
        ...
        productType: 'Supplements',
        categoryId: getCat('Supplements')._id,
        image: '/images/products/pre_workout_powder.png',
        sellingPrice: 1800,
        discountPrice: null,
        stock: 20,
        status: 'Active',
      ...
      },
      {
        ...
        image: '/images/products/resistance_bands.png',
        sellingPrice: 1200,
        discountPrice: 201,
      ...
      },
      {
        ...
        image: '/images/products/protein_bar.png',
        sellingPrice: 150,
        discountPrice: null,
        stock: 120,
        status: 'Active',
      ...
      },
      {
        ...
        productType: 'Gym Accessories',
        image: '/images/products/shaker_bottle.png',
        sellingPrice: 600,
        discountPrice: 150,
